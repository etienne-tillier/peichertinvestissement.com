...
export interface Author { id?: string; name: string; avatar_url?: string; bio?: string; role?: string; }
...
export interface BlogPost {
    ...
    excerpt?: string; focus_keyword?: string;
    cover?: { file_url: string; alt_text?: string };
